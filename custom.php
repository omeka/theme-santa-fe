...
add_filter(array('Display', 'Item', 'Dublin Core', 'Title'), 'santa_fe_show_untitled_items');

function santa_fe_show_untitled_items($title)
{
 ...
 *
 **/
function santa_fe_display_logo()
{
...
function santa_fe_show_item_metadata(array $options = array(), $item = null)
{
    if (!$item) {
...
function santa_fe_public_nav_header()
{    
...
function santa_fe_header_image()
{
...
function santa_fe_nav_items($navArray = array())
{
    if (!$navArray) {
